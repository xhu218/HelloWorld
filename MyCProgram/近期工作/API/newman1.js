...
flag = 1;
var dir = "/sobeyhive/app/cmserver-1.0.0/autotest/";
...
function replaceFilePath(obj){
	...
	var filepath 	= "5c486035ee29a6155c8bf36bf36f36a9";
	var fcpfilepath = "3c5c30e5b10161e1c5602a2da3a3eda4";
...
function replacePefPath(obj){
	...
	var jovepef_path = "PEF_New_1234369a804c4e95ab428fd2eb76a4ca";
...
function autoRun(obj){
	newman.run({
	    ...
	    if (err || summary.error) {
			...
			//obj.finishFlag = true;
			setTimeout(replaceFilePath, 30000);
