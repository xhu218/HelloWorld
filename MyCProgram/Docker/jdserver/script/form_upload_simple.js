...
Qiniu = {
    ...
    Test1: function(filepath) {
        ...
        var bucket = conf.Qiniu.bucket;//"xhu218";//proc.env.QINIU_TEST_BUCKET;
        var accessKey = conf.Qiniu.accessKey;//"5zICAtLUtlGbbMfDB2ucQ9OxyO3zwQTG6I5do11P";//proc.env.QINIU_ACCESS_KEY;
        var secretKey = conf.Qiniu.secretKey;//"c2mM0jRfxm9hYDdsbeFqBR4akbMqG8n6TpIl4mE7";//proc.env.QINIU_SECRET_KEY;
        //console.log(bucket,accessKey,secretKey);
