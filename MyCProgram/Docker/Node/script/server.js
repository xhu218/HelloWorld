...
/*
TODO:请确认admin的可用路径在此
*/
var _dst = "/ext_file_root/hivefiles/sobeyhive/bucket-z/u20011/cmupload/2017-04-21/";
...
TODO:请确认admin的可用路径在此
*/
var _dst_fcp = "/ext_file_root/hivefiles/sobeyhive/bucket-z/u20011/cmupload/2017-04-21/";
...
function replaceFilePath(obj){
	...
	var _dst_filepath =		_dst + filepath_guid +".mp4";//"d:\\1.mp4";//
...
function replacePefPath(obj){
	...
	var _dst_fcppef = 		_dst_fcp + fcppef_guid +".pef";	
