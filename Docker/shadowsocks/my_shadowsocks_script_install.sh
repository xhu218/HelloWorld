...
docker run -d -v "$(pwd)"/log:/var/log \
-p 1984:1984 --name my_shadowsocks_script my-shadowsocks-client-app \
-b 0.0.0.0 -s $YOUR_SERVER_IP -p $YOUR_SERVER_PORT -l 1984 -k $SSPASSWORD -m rc4-md5
